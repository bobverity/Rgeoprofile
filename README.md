...
RgeoProfile relies on the Rcpp package, and therefore the following installation steps are required:

#### Windows
- Download and install [Rtools](https://cran.rstudio.com/bin/windows/Rtools/) appropriate to your version of R
- Ensure that you've arranged your system PATH as recommended by Rtools (you can choose to do this automatically as part of Rtools installation if you like)
#### Linux
- foobar
